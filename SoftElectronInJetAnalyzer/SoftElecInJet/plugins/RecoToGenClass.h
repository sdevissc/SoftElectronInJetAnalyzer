...
RecoToGenFiller::RecoToGenFiller(const TString & tag){
	...
	tree_purity_GenElecB->Branch("pt",&RecoPt,"pt/F");
        tree_purity_GenElecB->Branch("eta",&RecoEta,"eta/F");
        tree_purity_GenElecB->Branch("phi",&RecoPhi,"phi/F");
        tree_purity_GenElecB->Branch("RecoE",&RecoE,"RecoE/F");
	tree_purity_GenElecB->Branch("TotalEnergy",&TotalEnergy,"TotalEnergy/F");
	...
	tree_purity_GenElecB->Branch("spp",&spp,"spp/F");
        tree_purity_GenElecB->Branch("PreShowerOverRaw",&PreShowerOverRaw,"PreShowerOverRaw/F");
	...
	tree_purity_GenElecB->Branch("weight",&weight,"weight/F");
	tree_purity_GenElecB->Branch("fromConversion",&fromConversion,"fromConversion/I");
	...
	tree_purity_GenElecB->Branch("fl",&fl,"fl/I");
