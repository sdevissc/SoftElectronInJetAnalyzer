...
// main GUI
//void TMVAGui( const char* fName = "SoftElectronMVA__BDTG_weight.root" ) 
void TMVAGui( const char* fName = "SEtagMVA__BDTG_weight.root" )
//void TMVAGui( const char* fName = "/mnt/data2/OutputBatchTMVA/2012/EmanueleNonTrigV1Cat1/ElectronMVA_NonTrig_BDTG.root" ) 
//void TMVAGui( const char* fName = "/mnt/data2/OutputBatchTMVA/2012/EmanueleNonTrigV2Cat4/ElectronMVA_NonTrig_BDTG.root" ) 
{   
   ...
   gROOT->SetMacroPath(curMacroPath+":./:TestTMVA:");
