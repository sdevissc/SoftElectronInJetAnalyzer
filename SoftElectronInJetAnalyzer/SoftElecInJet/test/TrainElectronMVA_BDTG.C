...
void TrainElectronMVA_BTDG_NonTrigV1_Cat1_2012() {
  ...
  tree->SetBranchAddress( "spp", &(treevars[15]) );
  tree->SetBranchAddress( "R9", &(treevars[16]) );	
  tree->SetBranchAddress( "etawidth", &(treevars[17]) );
  tree->SetBranchAddress( "phiwidth", &(treevars[18]) );
  tree->SetBranchAddress( "e1x5e5x5", &(treevars[19]) );
  tree->SetBranchAddress( "IoEmIoP", &(treevars[20]) );
  tree->SetBranchAddress( "PreShowerOverRaw", &(treevars[21]) );
  tree->SetBranchAddress( "nPV", &(treevars[22]) );

  tree->SetBranchAddress( "gedgsfElecPt",&(treevars[23]));
  tree->SetBranchAddress( "gedgsfElecEta",&(treevars[24])); 
