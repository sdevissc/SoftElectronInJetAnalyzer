...
void TrainElectronMVA_BTDG_NonTrigV1_Cat1_2012() {
  ...
  TMVA::Tools::Instance();
  TFile* outputFile = TFile::Open("SoftElectronMVA__BDTG_XXX.root", "RECREATE");
 ...
 // factory->AddVariable("PreShowerOverRaw",'F');
  ...
  factory->PrepareTrainingAndTestTree("YYY","YYY","nTrain_Signal=0:nTrain_Background=0:SplitMode=Block:!V" );
  

  
  factory->BookMethod(TMVA::Types::kBDT, "BDT_XXX", "!H:!V:NTrees=2000:BoostType=Grad:Shrinkage=0.10:!UseBaggedGrad:nCuts=2000:nEventsMin=100:NNodesMax=5:UseNvars=4:PruneStrength=5:PruneMethod=CostComplexity:MaxDepth=6" );
