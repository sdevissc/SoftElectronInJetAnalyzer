...
// main GUI
//void TMVAGui( const char* fName = "../ElectronMVA_Pt5To35_NonTrig_BDTG.root" ) 
//void TMVAGui( const char* fName = "/mnt/data2/OutputBatchTMVA/2012/EmanueleNonTrigV1Cat1/ElectronMVA_NonTrig_BDTG.root" ) 
void TMVAGui( const char* fName = "/data1/OutputBatchTMVA/2012/EmanueleNonTrigV1Cat1/ElectronMVA_NonTrig_BDTG.root" ) 
{   
